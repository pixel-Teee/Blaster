...
void ABlasterCharacter::AimOffset(float DeltaTime)
{
	...
	//{
	//	UE_LOG(LogTemp, Warning, TEXT("base yaw:%f, remote server yaw:%f"), GetBaseAimRotation().Yaw, AO_Yaw);
	//}
	//
	//if (HasAuthority())
	//{
...
void ABlasterCharacter::RotateInPlace(float DeltaTime)
{
	...
	{
		TimeSinceLastMovementReplication = TimeSinceLastMovementReplication + DeltaTime;
...
{
	if (Combat == nullptr) return FVector(0.0f);
